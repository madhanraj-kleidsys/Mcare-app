...
**Mcare App** is a system built with **Expo Go**, **React Native**, **Node.js**, & **MSSQL**.
...
``` bash
git clone https://github.com/madhanraj-kleidsys/Mcare-app.git
```
...
```bash
PORT=3000
HOST=LOCAL IP ADDRESS (eg: 192.168.0.117 )
NODE_ENV=DEVELOPMENT

DB_USER=sa
DB_PASSWORD=password@123 || kleid@123
DB_HOST=HOST || (local : DESKTOP-A9IOQAU)
DB_NAME=GAMD
DB_PORT=1433
...
```
✅ **API is now running at:** `http://198.162.0.117:3000`
